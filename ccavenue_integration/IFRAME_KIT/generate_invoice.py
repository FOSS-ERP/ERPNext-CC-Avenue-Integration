...
def get_quotation(doc):
    ...
    data =  {
        "customer_name": "FOSS ERP", "customer_email_id": "viral@fosserp.com", "customer_email_subject": "Quotation", "customer_mobile_no": "7990225354", "currency": "INR", 
        "valid_for": 2, "valid_type": "days", "item_List": [{
        "name": "ONDC Onboarding", 
        "description": "ONDC Onboarding", "quantity": "1.0", 
        "unit_cost": "1180.0", "tax_List": [
